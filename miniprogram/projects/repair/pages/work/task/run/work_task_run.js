...
Page({
	...
	data: {
		isLoad: false,
		fields: projectSetting.TASK_RUN_FIELDS,
	},
	...
	bindSubmitCmpt: async function (e) {
		...
		try {
            ...
            await cloudHelper.callCloudSumbit('work/task_run', params);
            
            let timeHelper = require('../../../../../../helper/time_helper');
			await cloudHelper.transFormsTempPics(forms, 'task-day/' + timeHelper.time('Y-M-D') + '/', id, 'work/task_update_run_forms');
			...
			pageHelper.showNoneToast('提交成功', 2000, cb);
		} catch (err) {
			console.log(err);
		}
